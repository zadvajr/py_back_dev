""" matplotlib and numpy module used """

#Plottig x and y points
#plot() function used to draw points(markers) in a diagram by default
# it draws line from point to point
...
#for example, to plot a line from (1,3) to (8,10) we have to pass two arrays
